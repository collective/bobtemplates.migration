...
package.description.default = A migration package for Plone
...
[template]
pre_render = bobtemplates.migration.jsonify:pre_renderer
post_render = bobtemplates.migration.jsonify:post_renderer
